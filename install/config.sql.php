...
$query[] = "INSERT INTO " . $sqltblpre . "faqconfig VALUES ('main.metaDescription', 'Автоматизированная система проведения турниров по шашкам и шахматам')";
...
$query[] = "INSERT INTO " . $sqltblpre . "faqconfig VALUES ('main.titleFAQ', 'Турнир')";
