...
<head>
    ...
    <meta name="application-name" content="<?php print $faqconfig->get('main.titleFAQ'); ?><?php print $faqconfig->get('main.currentVersion'); ?>">
    <meta name="copyright" content="(c) Maria Rudko 2012">
